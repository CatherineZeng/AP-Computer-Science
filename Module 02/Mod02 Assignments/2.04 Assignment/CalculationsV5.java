...
public class CalculationsV5
{
    public static void main(String[ ] args)
    {
        ...
        //System.out.println();
         ...
         // additional arithmetic equation 1
        System.out.println("My own Arithmetic equation 1");
        System.out.print( dNum1+" plus "+dNum2+" minus ("+dNum2+" times "+dNum1+") =");
        System.out.println( dNum1+dNum2-dNum2*dNum1);
        System.out.println();
        //System.out.println();
        
          // additional arithmetic equation 2
        System.out.println("My own Arithmetic equation 2");
        System.out.print( dNum1+" modulus "+dNum2+" divided by "+dNum1+"=");
        System.out.println( dNum1%dNum2/dNum1);
        System.out.println();
        //System.out.println();
